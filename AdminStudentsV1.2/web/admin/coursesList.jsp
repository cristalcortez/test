                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                            ...
                            <tbody>
                                <c:forEach items="${courses}" var="course" >
                                    <tr>
                                        ...
                                        <td><a href="Course?action=delete&course_id=<c:out value="${course.course_id}"/>">Delete</a></td>
                                        <td><a href="Course?action=edit&course_id=<c:out value="${course.course_id}"/>">Edit</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
                    ...
                    <div class="row">
                            <form action="Course" method="post">
                                <input type="hidden" name="active" id="active" value="course">

        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <form action="Mark" method="<c:out value="${methodName}"/>">
                        <label>Student ID</label>
                        <input type="text" name="student_id" value="<c:out value="${result.student_id}"/>">
                        <br>
                        <c:choose>
                            <c:when test="${action == 'edit'}">
                                <label>Student Name</label>
                                <input type="text" name="student_name" value="<c:out value="${result.student_name}"/>" readonly>
                                <br>
                            </c:when>
                        </c:choose>
                        <label>Course ID</label>
                        <input type="text" name="course_id" value="<c:out value="${result.course_id}"/>">
                        <br>
                        <c:choose>
                            <c:when test="${action == 'edit'}">
                                <label>Course Name</label>
                                <input type="text" name="course_name" value="<c:out value="${result.course_name}"/>" readonly>
                                <br>
                            </c:when>
                        </c:choose>
                        <label>Marks</label>
                        <input type="text" name="marks" value="<c:out value="${result.marks}"/>">  
                        <br>
                        <label>Semester</label>
                        <input type="text" name="semester" value="<c:out value="${result.semester}"/>">  
                        <br>
